						...
						<form action="{{url('/bookingg/search')}}" method="post">
							...
							<div class="row">
								...
								<div class="col-md-2 col-sm-6">
									<div class="dropdown">
										<select class="custom-select" name="clinic_id">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-btn">
										<button class="submit-btn">Searching</button>
									</div>
								</div>
							</div>
						</form>
					...
					<div id="content">
						...
						<div class="item">
							...
							<div id="dd1" class="wrapper-dropdown-2">المشفائ
								<p id="x-select">اختار المشفائ</p>
								<input type="hidden" name="clinic_id" id="clinic_id">
								<ul class="dropdown">
									@foreach ($clinics as $clinic)
								  <li onclick="x('{{$clinic->name}}', '{{$clinic->id}}')">{{$clinic->name}}</li>
								  @endforeach
						...
						<div class="item" >
							...
							<div id="dd4" class="wrapper-dropdown-2">Sign in with
								<ul class="dropdown">
								  <li><a href="#"><i class="icon-twitter icon-large"></i>Twitter</a></li>
								  <li><a href="#"><i class="icon-github icon-large"></i>Github</a></li>
								  <li><a href="#"><i class="icon-facebook icon-large"></i>Facebook</a></li>
						...
						<div class="item" style="	border-top-right-radius: 10px;border-bottom-right-radius: 10px;">
							...
							<div id="dd5" class="wrapper-dropdown-2" >Sign in with
								<ul class="dropdown">
								  <li><a href="#"><i class="icon-twitter icon-large"></i>Twitter</a></li>
								  <li><a href="#"><i class="icon-github icon-large"></i>Github</a></li>
								  <li><a href="#"><i class="icon-facebook icon-large"></i>Facebook</a></li>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="doctor-descrption ">
							...
							<div>
								...
								<div class="appointment-booking-btn">
