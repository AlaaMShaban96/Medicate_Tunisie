								...
								{{-- <div class="col-md-2 col-sm-6">
									...
									<div class="dropdown">
										<button class="btn btn-secondary dropdown-toggle search-bt search-bt" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											...
											<span class="detsils">Choose city</span>
										</button>
								...
								{{-- <div class="col-md-2 col-sm-6">
									<div class="dropdown">
										<button class="btn btn-secondary dropdown-toggle search-bt search-bt" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											...
											<span class="detsils">Choose area</span>
										</button>
										<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										  <li class="dropdown-item" >href="#">Action</li>
										  <li class="dropdown-item" href="#">Another action</li>
								...
								{{-- <div class="col-md-2 col-sm-6">
									<div class="dropdown">
										<button class="btn btn-secondary dropdown-toggle search-bt search-bt " type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											...
											<span class="detsils">Choose insurance</span>
										</button>
										<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										  <li class="dropdown-item" >href="#">Action</li>
										  <li class="dropdown-item" href="#">Another action</li>
								...
								{{-- <div class="col-md-2 col-sm-6">
									<div class="dropdown">
										...
										<button class="btn btn-secondary dropdown-toggle search-bt search-bt " type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										  ...
										  <span class="detsils">Doctor  or hospital</span>
										</button>
										<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										  <li class="dropdown-item" >href="#">Action</li>
										  <li class="dropdown-item" href="#">Another action</li>
				...
				<div class="card ">
				  <div class="additional">
					...
					<img src="data:image/jpeg;base64," alt="">
					  ...
					  <br>
					<a class="btn btn-primary" href="{{url('/booking/appointment/'.$appointmentAvailable->id)}}" role="button">احجز موعد</a>
					</div> 
					<div class="more-info">
					  ...
					  <div class="coords">
						...
						<span>
							اوقات العمل <i class="fa fa-money" aria-hidden="true"></i>
						</span>
						<div>
							@foreach ($appointmentAvailable->day as $day)
						<span>{{$day->name}}</span>
							@endforeach
				  ...
				  <div class="general">
				  <h3>{{$appointmentAvailable->doctor->name}}</h3>
