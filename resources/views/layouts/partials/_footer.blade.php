          ...
          <div class="wow fadeInDown" data-wow-delay="0.1s">
            <div class="widget">
              ...
              {{-- <ul class="company-social">
                <li class="social-facebook"><a href="https://web.facebook.com/MedicateTPA/?_rdc=1&_rdr"><i class="fa fa-facebook"></i></a></li>
                <li class="social-twitter"><a href="https://twitter.com/MedicateTPA"><i class="fa fa-twitter"></i></a></li>
                <li class="social-google"><a href="#"><i class="fa fa-google-plus"></i></a></li>
                <li x><a href="https://www.linkedin.com/in/MedicateTPA/"><i class="fa fa-linkedin-square" aria-hidden="true"></i>                </a></li>
          ...
          <div class="wow fadeInDown" data-wow-delay="0.1s">
            <div class="contact-form widget" >
              ...
              <form action="">
                ...
                <div class="input-group input-group-sm mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-sm">E-mail Adress</span>
                  </div>
                  <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                </div>
                <div class="input-group input-group-sm mb-3">
