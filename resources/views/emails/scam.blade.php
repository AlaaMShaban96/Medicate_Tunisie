										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
                                                            <td ><img src="{{asset('img/new_lolo.svg') }}" width="131" height="38" editable="true"  alt="{{config('app.name')}}" /></td>
                                                            {{-- <td ><img src="{{}}" width="131" height="38" editable="true"  alt="logo" /></td> --}}

															<td class="text-header" style="color:#475c77; font-family:'Muli', Arial,sans-serif; font-size:20px; line-height:16px; text-align:right;"><span class="link2" style="color:#475c77; text-decoration:none;">بريد البلاغات</span></td>
														</tr>
													</table>
												</th>
											</tr>
														...
														<td class="tbrr p30-15" style="padding: 60px 30px; border-radius:26px 26px 0px 0px;" bgcolor="#12325c">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	...
																	<td class="h1 pb25" style="color:#ffffff; font-family:'Muli', Arial,sans-serif; font-size:20px; line-height:46px; text-align:center; padding-bottom:25px;">أرغب في إبلاغ عن إحتيال : {{$request->report}}</td>
																</tr>
																<tr>
                                                                    <td class=" pb25" style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:15px;text-align:center;   padding-bottom:25px;">
                                                                        <h3>معلومات عن مقدم إبلاغ  </h3>
                                                                            ...
                                                                            <h5>إسم الشركة </h5>
                                                                            <p>{{$request->companeName}}</p>

                                                    
                                                                        
                                                                            <div style="line-height:25px;">
                                                                                <h3>وصف الحالة</h3>
                                                                            <p>{{$request->descriptionUcondition}}</p>
                                                                                <h3> البلاغ</h3>
                                                                            <p>{{$request->message}}</p>
                                                                         </div>
