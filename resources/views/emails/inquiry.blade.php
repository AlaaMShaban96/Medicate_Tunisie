												...
												<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td class="text-header" style="color:#475c77; font-family:'Muli', Arial,sans-serif; font-size:20px; line-height:16px; text-align:right;"><span class="link2" style="color:#475c77; text-decoration:none;">بريد الاستفسارات</span></td>
														</tr>
													</table>
												</th>
											</tr>
														...
														<td class="tbrr p30-15" style="padding: 60px 30px; border-radius:26px 26px 0px 0px;" bgcolor="#12325c">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																	...
																	<td class="h1 pb25" style="color:#ffffff; font-family:'Muli', Arial,sans-serif; font-size:20px; line-height:46px; text-align:center; padding-bottom:25px;">أرغب في الاستفسار عن : {{$request->aboutinquiry}}</td>
																</tr>
																<tr>
                                                                    <td class=" pb25" style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:15px;text-align:center;   padding-bottom:25px;">
                                                                        <h3>معلومات عن مقدم الاستفسار</h3>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="p30-15 bbrr" style="padding: 50px 30px; border-radius:0px 0px 26px 26px;" bgcolor="#0e264b">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="text-footer1 pb10" style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:20px; text-align:center; padding-bottom:10px;"><multiline>Medicate - مركز خدمة الشكوي</multiline></td>
											</tr>
											<tr>
