												...
												<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td class="text-header" style="color:#475c77; font-family:'Muli', Arial,sans-serif; font-size:20px; line-height:16px; text-align:right;"><span class="link2" style="color:#475c77; text-decoration:none;">بريد الحجوزات</span></td>
														</tr>
													</table>
												</th>
											</tr>
														...
														<td class="tbrr p30-15" style="padding: 60px 30px; border-radius:26px 26px 0px 0px;" bgcolor="#12325c">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																...
																<tr>
																	...
																	<h3>حجز موعد مع </h3>
																	<h4>{{$appointment->appointmentAvailable->doctor->name}}</h4>
																	<h3>  في عيادة  </h3>
																	<h4>{{$appointment->appointmentAvailable->clinic->name}}</h4>
																	<h3>  يوم  </h3>
																	<h4>{{$appointment->date}}</h4>
																	<h3>  تخصص  </h3>
																	<h4>{{$appointment->appointmentAvailable->service->name}}</h4>
																	<h3>  الساعة  </h3>
